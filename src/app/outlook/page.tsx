      ...
      <main className="flex-1">
        ...
        <section className="max-w-3xl mx-auto px-6 pt-20 pb-14 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-5">
            How Outlook import works
          </h1>
          <p className="text-lg text-gray-500 leading-relaxed">
            Hugo can scan your Outlook, Hotmail, or Live inbox to detect
            recurring subscriptions automatically. Here&apos;s exactly what
            happens — and what we never touch.
          </p>
        </section>
            ...
            {[
              {
                ...
                body: "When you click Connect Outlook, you're taken to Microsoft's own sign-in and consent screen. You decide whether to allow access. Hugo requests only the minimum permission required: read-only access to your mail messages. We cannot send, delete, or modify anything.",
              },
              {
                icon: <Eye className="h-5 w-5 text-blue-600" />,
                step: "2",
                title: "We search for billing emails",
                body: "Once connected, clicking Import from Outlook triggers a search of your last 6 months of email for messages with billing-related keywords in the subject — things like receipt, invoice, subscription, renewal, and payment. We fetch a maximum of 50 matching emails.",
              },
              {
              ...
              },
              {
                ...
                body: "You can revoke Hugo's access to your Outlook at any time by clicking the Outlook button in the dashboard header and choosing Disconnect. This immediately deletes your stored OAuth tokens from our database. You can also revoke access directly from your Microsoft Account at account.microsoft.com/privacy.",
              },
            ].map((item) => (
            ...
            <div className="rounded-xl border border-gray-200 overflow-hidden bg-white">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    { data: "Outlook OAuth tokens", stored: "Yes", yes: true, why: "Needed to call the Microsoft Graph API on your behalf when you trigger a scan." },
        ...
        <section className="pb-20">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Create a free account and connect Outlook in under two minutes.
            </p>
            <Link
              href="/register"
